    ...
    <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
      ...
      <div className="relative bg-gradient-to-r from-red-600 to-orange-500 px-8 py-6">
        ...
        <div className="relative text-center">
          ...
          <p className="text-red-100 text-sm mt-1">Aby uzyskać dostęp do tej strony</p>
        </div>
      </div>
      ...
      <div className="p-8 text-center">
        ...
        <div className="space-y-4">
          ...
          <Link
            to="/register"
            className="block w-full py-3 px-6 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          >
            Zarejestruj się
          </Link>
        </div>
