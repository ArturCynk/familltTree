...
import { faTree, faUserFriends, faFileAlt, faCog, faKey } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <footer className="bg-gray-200 text-center py-4">
        <p className="text-gray-600">&copy; {new Date().getFullYear()} Drzewo Genealogiczne. Wszystkie prawa zastrzeżone.</p>
      </footer>
    </div>
  );
};
